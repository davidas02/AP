...
public class Cuenta implements Comparable<Cuenta> {
     ...
     *
     * @param codigo Establece el codigo de la cuenta
     * @param titular Establece el titular de la cuenta
     * @param saldo Establece el saldo de la cuenta
     * @throws com.sauces.ap.SaldoException
     */
     ...
     * @return Lista de los movimientos desde la fecha desde hasta la fecha
     * hasta
     */
    ...
    /**
     * Metodo que permite realizar una transferencia de una cuenta a otra del
     * banco
     *
