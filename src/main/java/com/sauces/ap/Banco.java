...
/**
 *  Clase Banco de la AplicacionBanco
...
public class Banco {
    ...
    /**
     * Busca un codigo con el metodo privado buscarCuenta(String Codigo) y con
     * la posicion que devuelve el anterior metodo buscamos en la lista la
     * cuenta con el codigo requerido
     *
     * @param codigo String
     * @return Cuenta c
     */
